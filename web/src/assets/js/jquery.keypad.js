...
(function ($) { // hide the namespace
    ...
    function Keypad() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            tabText: 'â†’', // Display text for tab
        ...
        this._defaults = { // Global defaults for all the keypad instances
            ...
            layout: ['123', '456', '789', '0' + this.CLEAR], // Layout of keys
        ...
        this.mainDiv = $('<div class="pad"><div class="' + this._mainDivClass + '" style="display: none;"></div></div>');
    }
    ...
    $.extend(Keypad.prototype, {
        ...
        _attachPlugin: function (target, options) {
            ...
            var inst = {
                options: $.extend({}, this._defaults, options), _inline: inline,
